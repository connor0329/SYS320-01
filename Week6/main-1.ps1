...
while($operation){
    ...
    elseif($choice -eq 3){ 
        ...
        if(-not (checkPassword $password)){
            Write-Host "Password not strong enough"
            continue
        }
   ...
   elseif($choice -eq 9){
       ...
       $numberDays1 = Read-Host -Prompt "Please enter the amount of Days you would like to search back"
       ...
       Write-Host "Please select a valid option (1-10)"
       continue
   }
